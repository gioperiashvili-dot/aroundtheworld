...
Use an SMTP app password where the email provider requires it. Gmail returns
`535 5.7.8 Username and Password not accepted` when `SMTP_USER` or `SMTP_PASS`
is not an accepted mailbox/app-password pair.
