...
export default function Navbar({ variant = "page" }) {
  ...
  const navContainerClassName =
    "aw-navbar rounded-[1.25rem] border border-white/12 bg-[rgba(7,25,31,0.72)] px-3 py-3 shadow-[0_24px_80px_-58px_rgba(0,0,0,0.95)] backdrop-blur-xl sm:px-5";
  const menuPanelClassName =
    "border-white/12 bg-[rgba(7,25,31,0.96)] shadow-[0_24px_70px_-48px_rgba(0,0,0,0.95)] backdrop-blur-xl";

  return (
    <nav className={`sticky top-3 z-30 w-full ${navContainerClassName}`}>
      <div className="hidden min-w-0 items-center gap-5 xl:flex">
        ...
        <div className="flex min-w-0 flex-shrink-0 items-center justify-end gap-2">
          <button
            ...
            className="aw-premium-button flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border border-white/12 text-slate-950 transition hover:-translate-y-0.5"
        ...
        >
          ...
          <div className="border-t border-white/10 pt-4">
            <button
              ...
              className="aw-premium-button flex w-full items-center justify-between rounded-[1rem] border border-white/10 px-4 py-3 text-left text-sm font-black uppercase text-slate-950 transition hover:-translate-y-0.5"
            >
...
function BrandLink({ compact = false, navSubtitle }) {
  return (
    <Link to="/" className="group flex min-w-0 flex-shrink-0 items-center gap-3 text-left">
      <span
        className={`flex items-center rounded-[0.95rem] border border-white/12 bg-white/10 px-2.5 shadow-[0_16px_34px_-28px_rgba(0,0,0,0.95)] backdrop-blur transition group-hover:border-[rgba(246,196,69,0.28)] ${
          compact ? "h-11" : "h-12"
        }`}
      >
        <img
...
function getDesktopNavLinkClass(isActive) {
  return `whitespace-nowrap rounded-full px-3.5 py-2 text-sm font-semibold transition 2xl:px-4 ${
    isActive
      ? "bg-[rgba(246,196,69,0.94)] text-slate-950 shadow-[0_14px_32px_-24px_rgba(246,196,69,0.95)]"
    ...
    >
      ...
      <div className="relative flex-shrink-0">
        <button
          ...
          className={
            mobile
              ? "flex min-h-11 w-full items-center justify-between rounded-[1rem] border border-white/12 bg-white/8 px-4 py-3 text-sm font-semibold text-white/84 transition hover:border-[rgba(246,196,69,0.42)] hover:bg-white/12 hover:text-white disabled:cursor-wait disabled:opacity-70"
              : "flex h-10 w-10 items-center justify-center rounded-full border border-white/12 bg-white/8 text-white/84 transition hover:-translate-y-0.5 hover:border-[rgba(246,196,69,0.42)] hover:bg-white/12 hover:text-white disabled:cursor-wait disabled:opacity-70"
          }
        ...
        {isAccountMenuOpen ? (
          <div
            className={`z-50 mt-2 overflow-hidden rounded-[1rem] border border-white/12 bg-[rgba(13,37,45,0.98)] p-1 text-sm font-semibold text-white shadow-[0_20px_70px_-38px_rgba(0,0,0,0.95)] backdrop-blur ${
  ...
  return (
    <div className={`relative flex-shrink-0 ${mobile ? "w-full" : ""}`}>
      <button
        ...
        className={
          mobile
            ? "flex min-h-11 w-full items-center justify-between rounded-[1rem] border border-white/12 bg-white/8 px-4 py-3 text-sm font-semibold text-white/84 transition hover:border-[rgba(246,196,69,0.42)] hover:bg-white/12 hover:text-white"
            : "flex h-10 min-w-12 items-center justify-center gap-2 rounded-full border border-white/12 bg-white/8 px-2.5 text-white/84 transition hover:-translate-y-0.5 hover:border-[rgba(246,196,69,0.42)] hover:bg-white/12 hover:text-white"
        }
      ...
      {isOpen ? (
        <div
          className={`z-50 mt-2 overflow-hidden rounded-[0.95rem] border border-white/12 bg-[rgba(13,37,45,0.98)] p-1 text-sm font-semibold text-white shadow-[0_20px_70px_-38px_rgba(0,0,0,0.95)] backdrop-blur ${
