...
const FOOTER_LINK_CLASS =
  "text-sm font-medium leading-6 text-white/68 transition hover:text-white";
...
export default function PublicFooter() {
  ...
  return (
    <footer className="relative z-10 mx-auto w-full max-w-[1500px] px-4 pb-10 sm:px-6 lg:px-8">
      <div className="aw-glass-panel overflow-hidden rounded-[2rem] text-white">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/12 bg-white/8 transition hover:-translate-y-0.5 hover:border-[rgba(246,196,69,0.36)] hover:bg-white/14"
                >
        ...
        <div className="px-6 py-5 text-sm text-white/54 sm:px-8 lg:px-10">
