...
export const PAGE_SEO = {
  ...
  blog: {
    title: "მოგზაურობის ბლოგი | Aroundworld",
    description:
      "გაიგე სასარგებლო რჩევები მოგზაურობაზე, ტურებზე, ავიაბილეთებზე, სასტუმროებზე, ვიზებსა და პოპულარულ მიმართულებებზე Aroundworld.ge-ის ბლოგში.",
...
export default function SEO({
  ...
  const openGraphImageSource = image || ogImage || (useDefaultImage ? DEFAULT_OG_IMAGE : "");
  const openGraphImage = openGraphImageSource
    ? toAbsoluteImageUrl(openGraphImageSource)
    : "";
