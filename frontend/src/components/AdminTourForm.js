...
const TOUR_STATUS_OPTIONS = ["active", "draft"];

const TOUR_EXTRA_FIELD_TEXT = {
  ka: {
    days: "\u10D3\u10E6\u10D4\u10D4\u10D1\u10D8",
    nights: "\u10E6\u10D0\u10DB\u10D4\u10D4\u10D1\u10D8",
...
function getTourStatusText(language) {
  return TOUR_STATUS_TEXT[language] || TOUR_STATUS_TEXT.en;
}

function getTourExtraFieldText(language, key) {
  return TOUR_EXTRA_FIELD_TEXT[language]?.[key] || TOUR_EXTRA_FIELD_TEXT.en[key] || key;
}
...
export default function AdminTourForm({
  ...
  const statusText = getTourStatusText(language);
    ...
    <div className="grid gap-6 xl:grid-cols-[0.8fr_1.2fr]">
      ...
      >
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <label className="space-y-2">
            <span className="text-sm font-semibold text-slate-700 dark:text-slate-200">
              {getTourExtraFieldText(language, "days")}
            </span>
            <input
              name="days"
              type="number"
          ...
          <label className="space-y-2">
            <span className="text-sm font-semibold text-slate-700 dark:text-slate-200">
              {getTourExtraFieldText(language, "nights")}
            </span>
            <input
              name="nights"
              type="number"
        ...
        <section className="space-y-4 rounded-[1.6rem] border border-[#efe4d4] bg-[#faf4ea] p-4 dark:border-white/10 dark:bg-slate-800/70">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <label className="block space-y-2">
              <span className="text-sm font-semibold text-slate-700 dark:text-slate-200">
                {getTourExtraFieldText(language, "seoTitleKa")}
              </span>
              <textarea
                name="seoTitleKa"
            ...
            <label className="block space-y-2">
              <span className="text-sm font-semibold text-slate-700 dark:text-slate-200">
                {getTourExtraFieldText(language, "seoTitleEn")}
              </span>
              <textarea
                name="seoTitleEn"
            ...
            <label className="block space-y-2">
              <span className="text-sm font-semibold text-slate-700 dark:text-slate-200">
                {getTourExtraFieldText(language, "seoDescriptionKa")}
              </span>
              <textarea
            ...
            <label className="block space-y-2">
              <span className="text-sm font-semibold text-slate-700 dark:text-slate-200">
                {getTourExtraFieldText(language, "seoDescriptionEn")}
              </span>
              <textarea
            ...
            <label className="space-y-2 md:col-span-2">
              <span className="text-sm font-semibold text-slate-700 dark:text-slate-200">
                {getTourExtraFieldText(language, "canonicalUrl")}
              </span>
              <input
                name="canonicalUrl"
