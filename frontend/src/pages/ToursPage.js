      ...
      heroBody={
        <div className="flex flex-wrap gap-3 pt-2">
          <a
            ...
            className="aw-premium-button inline-flex items-center justify-center rounded-full px-5 py-3 text-sm font-black text-slate-950 transition hover:-translate-y-0.5"
          >
            {landingContent.cta.viewTours}
          </a>
          <a
            href={`#${TOURS_LISTING_ID}`}
            className="inline-flex items-center justify-center rounded-full border border-white/14 bg-[#031015]/28 px-5 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:border-[rgba(246,196,69,0.42)] hover:text-[var(--aw-accent)]"
          >
            {landingContent.cta.requestBooking}
          </a>
          <Link
            to="/flights"
            className="inline-flex items-center justify-center rounded-full border border-white/14 bg-white/8 px-5 py-3 text-sm font-semibold text-white/82 transition hover:-translate-y-0.5 hover:border-white/28 hover:text-white"
          >
    ...
    >
      ...
      <div className="space-y-10">
        ...
        <LandingSection title={landingContent.categories.title}>
          <div className="flex flex-wrap gap-3">
            {landingContent.categories.items.map((category) => (
              <span
                key={category}
                className="rounded-full border border-[rgba(246,196,69,0.26)] bg-[var(--aw-accent-soft)] px-4 py-2 text-sm font-semibold text-white/86"
              >
                {category}
              </span>
            ))}
        ...
        <section id={TOURS_LISTING_ID} className="scroll-mt-28 space-y-6">
          ...
          >
            {!loading ? (
              <div className="aw-surface-card rounded-[1.35rem] p-4 text-white">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                  ...
                  <div className="relative w-full lg:w-80">
                    <button
                      ...
                      className="flex min-h-11 w-full items-center justify-between rounded-[1rem] border border-white/12 bg-white/8 px-4 py-3 text-sm font-black uppercase text-white transition hover:border-[rgba(246,196,69,0.42)] hover:bg-white/12"
                    ...
                    {isFiltersOpen ? (
                      <div className="mt-3 grid gap-4 rounded-[1.15rem] border border-white/12 bg-[rgba(7,25,31,0.98)] p-4 shadow-[0_24px_70px_-44px_rgba(0,0,0,0.95)] backdrop-blur lg:absolute lg:right-0 lg:top-full lg:z-20 lg:w-80">
                        <label className="grid gap-2">
                          ...
                          <select
                            ...
                            className="min-h-11 rounded-[0.9rem] border border-white/10 bg-[var(--aw-input)] px-3 text-sm font-bold text-slate-950 outline-none transition focus:border-[var(--aw-accent)]"
                          >
                        ...
                        {hasActiveFilters ? (
                          <button
                            ...
                            className="rounded-[0.9rem] border border-white/12 px-4 py-3 text-sm font-semibold text-white/74 transition hover:border-[rgba(246,196,69,0.42)] hover:text-white"
                          >
        ...
        <LandingSection title={landingContent.booking.title}>
          <div className="grid gap-4 md:grid-cols-4">
            {landingContent.booking.steps.map((step, index) => (
              <article
                key={step}
                className="aw-surface-card rounded-[1.25rem] p-5 text-white transition hover:-translate-y-0.5 hover:border-[rgba(246,196,69,0.32)]"
              >
                <span className="aw-premium-button inline-flex h-9 w-9 items-center justify-center rounded-full text-sm font-black text-slate-950">
                  {index + 1}
                </span>
          ...
          <p className="rounded-[1.1rem] border border-[rgba(246,196,69,0.24)] bg-[var(--aw-accent-soft)] p-4 text-sm leading-7 text-white/82">
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {landingContent.directions.items.map((direction) => (
              <a
                key={direction.title}
                href={`#${TOURS_LISTING_ID}`}
                className="aw-surface-card group rounded-[1.25rem] p-5 text-white transition hover:-translate-y-1 hover:border-[rgba(246,196,69,0.32)]"
              >
        ...
        <LandingSection title={landingContent.why.title}>
          <div className="aw-surface-card rounded-[1.35rem] p-6 text-white md:p-8">
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              <Link
                to="/flights"
                className="rounded-full border border-white/12 bg-white/8 px-4 py-2 text-sm font-semibold text-white/78 transition hover:-translate-y-0.5 hover:border-[rgba(246,196,69,0.42)] hover:text-white"
              >
                {landingContent.cta.flights}
              </Link>
              <Link
        ...
        <LandingSection title={landingContent.faq.title}>
          <div className="grid gap-4 md:grid-cols-2">
            {landingContent.faq.items.map((item) => (
              <article
                key={item.question}
                className="aw-surface-card rounded-[1.25rem] p-5 text-white"
              >
        ...
        <section className="rounded-[1.5rem] border border-[rgba(246,196,69,0.24)] bg-[linear-gradient(135deg,rgba(246,196,69,0.16),rgba(13,37,45,0.96)_42%,rgba(3,16,21,0.98))] p-6 text-white shadow-[0_34px_110px_-70px_rgba(0,0,0,0.95)] md:p-8">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Link
              to="/flights"
              className="inline-flex items-center justify-center rounded-full border border-white/14 bg-white/8 px-5 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:border-[rgba(246,196,69,0.42)] hover:text-[var(--aw-accent)]"
            >
              {landingContent.cta.flights}
            </Link>
          </div>
  ...
  return (
    <section className={`space-y-6 ${className}`}>
      <div className="max-w-3xl">
        <h2 className="[font-family:var(--font-display)] text-3xl font-bold leading-tight text-white md:text-4xl">
          {title}
        </h2>
        {description ? (
...
function InfoCard({ title, text }) {
  return (
    <article className="aw-surface-card rounded-[1.25rem] p-5 text-white transition hover:-translate-y-1 hover:border-[rgba(246,196,69,0.32)]">
